...
INSERT INTO Employee
	(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, SALARY, JOINING_DATE, DEPARTMENT,MANAGER_ID) VALUES
		(001, 'James', 'Smith', 100000, '2000-02-17', 'HR', 002),
		(002, 'Jessica', 'Kohl', 80000, '2011-06-17', 'Admin', 005),
		(003, 'Alex', 'Garner', 300000, '2000-02-17', 'HR', 011),
		(004, 'Pratik', 'Pandey', 500000, '2000-02-17', 'Admin', 020),
		(005, 'Christine', 'Robinson', 500000, '2011-06-17', 'Admin', 007),
		(006, 'Deepak', 'Gupta', 200000, '2011-06-17', 'Account', 015),
		(007, 'Jennifer', 'Paul', 75000, '2000-01-17', 'Account', 012),
		(008, 'Deepika', 'Sharma', 90000, '2011-04-17', 'Admin', 017);
...
INSERT INTO Title 
 ...
 (6, 'christine', '2018-02-27', False),
 (7, 'bolt', '2018-02-28', False),
 (8, 'jessica', '2018-01-11', False),
 (9, 'paul', '2018-04-23', False),
